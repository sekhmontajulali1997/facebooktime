const dynamicfbPost = document.querySelector('.postList');

let allPost = '';

fbPost.reverse().map((item, index) => {

    allPost += `<div class="user-post">
    <div class="user-post-header">
      <div class="post-info">
        <img src="${item.autor.au_photo}" alt="" />
        <div class="user-details">
          <a class="author" href="#">${item.autor.name}</a>
          <span
            >10m
            <svg
              fill="currentColor"
...
dynamicfbPost.innerHTML = allPost;